...
type ShoppingCartServiceClient interface {
	AddItem(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ProductRequest, ProductResponse], error)
}
...
func (c *shoppingCartServiceClient) AddItem(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ProductRequest, ProductResponse], error) {
...
type ShoppingCartService_AddItemClient = grpc.BidiStreamingClient[ProductRequest, ProductResponse]
...
type ShoppingCartServiceServer interface {
	AddItem(grpc.BidiStreamingServer[ProductRequest, ProductResponse]) error
...
func (UnimplementedShoppingCartServiceServer) AddItem(grpc.BidiStreamingServer[ProductRequest, ProductResponse]) error {
...
func _ShoppingCartService_AddItem_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ShoppingCartServiceServer).AddItem(&grpc.GenericServerStream[ProductRequest, ProductResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ShoppingCartService_AddItemServer = grpc.BidiStreamingServer[ProductRequest, ProductResponse]
